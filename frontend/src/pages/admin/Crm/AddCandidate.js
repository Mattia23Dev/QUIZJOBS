...
function AddCandidate(props) {
  const {showAddCandidateModal, addStatus, setShowAddCandidateModal,examId,refreshData, selectedCandidate, setSelectedCandidate, jobPosition, exams} = props
        ...
        <div className="modal-candidate-body">
          ...
          <><div className='modal-candidate-middle'>
            <div className='modal-punteggio'>
              <p>Test svolti</p>
              <p><font color='#34C15B'>{candidate?.tests.length > 0 ? candidate.tests.length : '0'}</font></p>
            </div>
