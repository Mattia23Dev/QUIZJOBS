...
function ProtectedRoute({
  ...
  const getIsActiveOrNot = (paths) => {
    if (paths.includes(activeRoute)) {
      ...
      if (
        activeRoute.includes("/admin/exams/info") &&
        paths.includes("/admin/exams")
      ) {
        return true;
      }
  ...
  useEffect(() => {
    if (routeWithSidebar.includes(pathname)) {
      setCollapsed(false);
    } else {
      setCollapsed(true);
    }
  ...
  return (
    user && (
      <div className="layout">
            ...
            <div className="header flex justify-between">
              ...
              >
                ...
                <div
                  ...
                  className="flex justify-center items-center gap-1 profile-header-mobile"
                >
                  {user?.profileImage ? (
                    <img
        ...
        <Tour
          isOpen={openTour && tour === "total" ? true : false}
          onRequestClose={() => {
            setOpenTour(false);
            setTour("");
          }}
